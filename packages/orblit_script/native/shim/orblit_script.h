...
typedef struct OrblitScriptHost OrblitScriptHost;
...
/// orblit_script_string_free: the result coerced to string on success, or the
...
/// receives the message and stack, as for orblit_script_eval.
///
...
void orblit_script_string_free(char *s);
